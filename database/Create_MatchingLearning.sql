...
INSERT INTO [dbo].[Candidate] ([DeliveryUnitId], [RelationType], [FirstName], [LastName], [DocType], [DocNumber], [EmployeeNumber], [InBench], [Picture], [IsActive]) SELECT [Id], 1, 'Fernado', 'Olmos', NULL, NULL, 20578, 1 , 'MVD/Fernando_Olmos.JPG', 1 FROM [dbo].[DeliveryUnit] WHERE [Code] = 'MVD'
